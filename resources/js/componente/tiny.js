...
tinymce.init({
  ...
  toolbar:
    "undo redo | image editimage table tableofcontents bold italic underline alignleft aligncenter alignright alignjustify  | outdent indent | ltr rtl | numlist bullist | print | preview |listMenuCustom lineheight fontsize | code",
